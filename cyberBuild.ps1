...
$CollectorApps = @("ntdsaudit","RemoteExecutionEnablerforPowerShell","PingCastle","ntdsaudit","goddi","SharpHound","Red-Team-Scripts","Scuba-Windows","azscan3","LGPO","grouper2","Outflank-Dumpert")
